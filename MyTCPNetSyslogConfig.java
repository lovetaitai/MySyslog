 ...
 */
public class MyTCPNetSyslogConfig extends AbstractNetSyslogConfig implements TCPNetSyslogConfigIF {
    ...
    public MyTCPNetSyslogConfig(int facility, String host, int port) {
        super(facility, host, port);
        initialize();
    }

    public MyTCPNetSyslogConfig(int facility, String host) {
        super(facility, host);
        initialize();
    }

    public MyTCPNetSyslogConfig(int facility) {
        super(facility);
        initialize();
    }

    public MyTCPNetSyslogConfig(String host, int port) {
        super(host, port);
        initialize();
    }

    public MyTCPNetSyslogConfig(String host) {
        super(host);
        initialize();
    }
    ...
    public Class getSyslogWriterClass() {
        return MyTCPNetSyslogWriter.class;
    }
}
